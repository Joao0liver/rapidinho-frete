...
if($_SESSION['id_user'] == '' || $_SESSION['email_user'] == null || $_SESSION['nivel_user'] <> 777){
    ...
    function obterRegistros($pagina, $limite){ // Obtém os registros de entrega em andamento
    ...
    function contarRegistros(){ // Conta os registros para fazer paginação da Lista
        ...
        // Faz uma consulta com contagem dos registros onde o status for "Em Andamento"
        $sql = "SELECT COUNT(*) AS total FROM tbl_entrega WHERE status_ent = 0 OR status_ent = 1";
        $rodar_sql = mysqli_query($conn, $sql);
