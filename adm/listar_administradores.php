...
if($_SESSION['id_user'] == '' || $_SESSION['email_user'] == null || $_SESSION['nivel_user'] <> 777){
    ...
    function obterRegistros($pagina, $limite){ // Obtém os registros de administradores

        $conn = conexao();

        $offset = ($pagina - 1) * $limite; // Define o offset

        if ($_SERVER['REQUEST_METHOD'] === 'POST') { // Caso o usuário realize uma busca de administrador por ID
    ...
    function contarRegistros(){ // Conta os registros para fazer paginação da Lista
        ...
        // Faz uma consulta com contagem dos registros de administradores
...
<!-- Blank Start -->
            <div class="container-fluid pt-4 px-4">    
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">Registro de Administradores</h6>
