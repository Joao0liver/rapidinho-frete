            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-file-alt me-2"></i>Administradores</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="../adm/cadastrar_novo_adm.php" class="dropdown-item">Cadastrar</a>
                            <a href="../adm/listar_administradores.php" class="dropdown-item">Registro</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="cadastrar_mtboy_adm.php" class="dropdown-item">Cadastrar</a>
                            <a href="../adm/listar_mtboy_adm.php" class="dropdown-item">Registro</a>
                        </div>
                    </div>
                    <a href="../adm/listar_cliente_adm.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Clientes</a>
                    <a href="../adm/listar_precos_adm.php" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Preços</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                <a href="index.html" class="navbar-brand d-flex d-lg-none me-4">
                    <h2 class="text-primary mb-0"><img src="../layout/img/logo.png" height="45px" width="45px"></i></h2>
                </a>
